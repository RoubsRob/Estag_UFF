 ...
 * @author Henrique
 */
@WebServlet(name = "CriaCoordenador", urlPatterns = {"/CriaCoordenador"})
public class CriaCoordenador extends HttpServlet {
...
try{
       System.out.println("Entrou no servlet CriaCoordenador");
        ...
        try {
              ...
              if(Coordenador_DAO.criar(id,nome_user, senha_user,nome)){  
