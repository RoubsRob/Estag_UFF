 ...
 * @author Henrique
 */
@WebServlet(name = "CriaEmpresa", urlPatterns = {"/CriaEmpresa"})
public class CriaEmpresa extends HttpServlet {

   protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        System.out.println("Entrou no VERIFICAR LOGIN!!!");
try{
       System.out.println("Entrou no servlet CriaEmpresa");
        ...
        try {
              ...
              if(EmpresaDAO.Criar(id,nome_user, senha_user, nome, cnpj)){  
