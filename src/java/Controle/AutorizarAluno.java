 ...
 * @author Henrique
 */
@WebServlet(name = "AutorizarAluno", urlPatterns = {"/AutorizarAluno"})
public class AutorizarAluno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AutorizarAluno</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                out.println("Falha ao autorizar.<br/>");
            }
            out.println("</body>");
            out.println("</html>");
        }
